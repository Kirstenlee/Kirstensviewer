...
void LLFloaterTools::refresh()
{
...
#endif
    {
        ...
        {
            // Unless multiple parcels selected, highlight parcel object is at.
            ...
            // S24: Removed useless warning spam - no selection during rez/delete is normal, handled gracefully
        }

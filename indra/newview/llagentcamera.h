...
public:
	...
	// S24: Smooth movement - get interpolated values
	F32				getSmoothedAtKey() const		{ return mSmoothedAtKey; }
	F32				getSmoothedLeftKey() const		{ return mSmoothedLeftKey; }
	F32				getSmoothedUpKey() const		{ return mSmoothedUpKey; }
	F32				getSmoothedYawKey() const		{ return mSmoothedYawKey; }
	...
	// S24: Update smooth movement interpolation
	void			updateSmoothMovement(F32 dt);
...
private:
	...
	// S24: Smooth movement - interpolated values for ease-in/ease-out
	F32				mSmoothedAtKey;
	F32				mSmoothedLeftKey;
	F32				mSmoothedUpKey;
	F32				mSmoothedYawKey;

...
void LLViewerFloaterReg::registerFloaters()
{
    ...
    LLFloaterReg::add("kv_quick_chat", "floater_kv_quick_chat.xml", (LLFloaterBuildFunc)&LLFloaterReg::build<KVFloaterQuickChat>);
    ...
    LLFloaterReg::add("debug_console", "floater_debug_console.xml", (LLFloaterBuildFunc)&LLFloaterReg::build<KVDebugConsole>);

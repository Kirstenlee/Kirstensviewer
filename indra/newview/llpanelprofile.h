...
protected:
    ...
    void onSaveDescriptionChanges();
    void onDiscardDescriptionChanges();
    void onShowProfileTexture(); // S24: Show expanded First Life picture
    ...
    LLHandle<LLFloater> mFloaterTexturePickerHandle;
    LLHandle<LLFloater> mFloaterProfileTextureHandle; // S24: For expanded view
...
private:
    ...
    KVPanelProfileMetadata*     mPanelMetadata;

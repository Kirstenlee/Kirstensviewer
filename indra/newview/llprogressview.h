...
public:
	...
	// S24: Tech status display
	void setTechStatus(const std::string& status_text);
...
protected:
	...
	LLTextEditor* mTechStatusText = nullptr;
	LLTextBox* mTechStartupTimer = nullptr;
	F32 mPercentDone;
	std::string mMessage;
	LLButton*	mCancelBtn;
	LLFrameTimer mFadeToWorldTimer;
	LLFrameTimer mFadeFromLoginTimer;
	LLFrameTimer mStartupTimer;
	LLRect mOutlineRect;

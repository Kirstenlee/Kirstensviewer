...
void LLAttachmentsMgr::onAttachmentArrived(const LLUUID& inv_item_id)
{
    ...
    // S24: Removed wasteful LL_WARNS for unexpected attachments - user cannot rectify, wastes CPU on string/UUID formatting
...
void LLAttachmentsMgr::onDetachCompleted(const LLUUID& inv_item_id)
{
    ...
    // S24: Removed wasteful LL_WARNS for unexpected detach - user cannot rectify, wastes CPU on string/UUID formatting

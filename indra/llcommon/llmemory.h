...
inline void* ll_aligned_malloc_16(size_t size) // MUST be freed with ll_aligned_free_16()
{
...
inline void* ll_aligned_malloc_32(size_t size) // MUST be freed with ll_aligned_free_32()
{
...
inline void* ll_aligned_malloc(size_t size)
{
    void* ret;

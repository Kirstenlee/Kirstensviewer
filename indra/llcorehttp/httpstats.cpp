...
void HTTPStats::dumpStats()
{
    ...
    // This is diagnostic/statistics data for HTTP performance analysis - not a warning condition.
    // LL dumped this at WARNING level during development. Users don't need HTTP transfer stats in production logs.
    LL_DEBUGS("HTTPCore") << out.str() << LL_ENDL;
}

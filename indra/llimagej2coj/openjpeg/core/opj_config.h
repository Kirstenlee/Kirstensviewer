 ...
 */
    ...
    #define SL_EMBEDDED_OPENJPEG 0  // Default: OFF (use vcpkg library)
#endif
...
#define OPJ_NUM_THREADS     4   // Thread pool size for parallel decode
...
// Build type
#if SL_EMBEDDED_OPENJPEG
    #define OPENJPEG_VERSION "2.5.4-SL-Embedded-Optimized"
#else
...
// Compiler detection
    ...
    #define OPJ_COMPILER_GCC
    #define OPJ_INLINE inline __attribute__((always_inline))
#else
    #define OPJ_INLINE inline
#endif

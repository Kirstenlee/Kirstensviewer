...
class LLStreamingAudioInterface
{
 public:
	...
	// Get stream metadata (title, artist). Returns true if metadata has changed since last call.
	virtual bool getMetadata(std::string& title, std::string& artist) { return false; }
};

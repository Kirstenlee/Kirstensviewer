...
public:
    ...
    {                                       // Shader uniform name, set in LLShaderMgr::initAttribsAndUniforms()
        ...
        WATER_METALLIC,                     //  "waterMetallic" // S24
        WATER_ROUGHNESS_OVERRIDE,           //  "waterRoughnessOverride" // S24
        WATER_SPECULAR_INTENSITY,           //  "waterSpecularIntensity" // S24
        WATER_REFLECTION_INTENSITY,         //  "waterReflectionIntensity" // S24
        WATER_COLOR_TINT,                   //  "waterColorTint" // S24 Advanced
        WATER_COLOR_TINT_ALPHA,             //  "waterColorTintAlpha" // S24 Advanced
        WATER_FRESNEL_POWER,                //  "waterFresnelPower" // S24 Advanced
        WATER_WAVE_SPEED,                   //  "waterWaveSpeed" // S24 Advanced

...
void LLRenderSphere::renderGGL()
{
    ...
    if (mVertexBuffer.isNull())
    {
        ...
        // Add static_assert here to verify U16 can hold all vertex indices
        static_assert((LATITUDE_SLICES + 1) * (LONGITUDE_SLICES + 1) <= 65536, 
                      "Vertex count exceeds U16 index range");
